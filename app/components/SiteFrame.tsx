...
function Arrow(){return <span className="ui-arrow" aria-hidden>↗</span>}
...
function Navigation(){
 ...
 return <header className={`site-nav ${open?"menu-is-open":""}`} data-theme="hero">
  ...
  <div className="nav-bar">
   <a href="/" className="nav-logo" onClick={e=>{e.preventDefault();go("/")}} aria-label="Forty Pixels home"><img src="/brand/logo.png" alt="Forty Pixels"/></a>
  ...
  <div className="footer-shell">
   <div className="footer-main">
    ...
    <div className="footer-directory">
     ...
     <form className="footer-subscribe" action="mailto:hello@fortypixels.com" method="post" encType="text/plain"><label htmlFor="footer-email">Useful notes for founders</label><div><input id="footer-email" type="email" name="newsletter" required placeholder="Your email"/><button aria-label="Subscribe">→</button></div><small>No spam. Only practical design and website advice.</small></form>
   ...
   <div className="footer-bottom"><span>© 2026 FORTY PIXELS</span><span>VIDEO FOOTAGE: <a href="https://coverr.co" target="_blank" rel="noreferrer">COVERR</a></span><a href="#top">BACK TO TOP ↑</a></div>
  </div>
 </footer>
}
